...
class TxaLanguage {
  ...
  static final Map<String, Map<String, String>> _dicts = {
    'vi': {
      ...
      'show_speed_notif_desc': 'Hiện chỉ báo tốc độ trên thanh trạng thái & màn hình khóa',
      ...
      'web_browser_cast_desc': 'Mở link video trong trình duyệt có hỗ trợ truyền tải',
      ...
      'download_all_completed': 'Đã tải xong toàn bộ phim',
      ...
      'download_all_failed': 'Không thể thêm tập phim nào. Kiểm tra kết nối mạng!',
      ...
      'no_internet_msg': 'Vui lòng kiểm tra kết nối internet để xem phim trực tuyến hoặc tải phim về xem ngoại tuyến.',
    ...
    'en': {
      ...
      'permission_alarm_desc': 'Required to send showtime notifications on time.',
      'view_all': 'View all',
      ...
      'auto_quality_desc': 'Automatically optimize quality based on network speed',
      'show_speed_notif': 'Show speed in notification',
      'show_speed_notif_desc': 'Show speed indicator on status bar & lock screen',
      ...
      'web_browser_cast_desc': 'Open video link in browser with casting support',
      ...
      'download_all_completed': 'All episodes downloaded',
      ...
      'cannot_download_episode': 'Could not download episode. Please try again!',
      ...
      'no_internet_msg': 'Please check your internet connection to watch online or download movies for offline viewing.',
